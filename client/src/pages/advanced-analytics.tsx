...
import { BarChart3, TrendingUp, TrendingDown, PieChart, Activity, Target, Brain, Zap, Eye, Users } from "lucide-react";
  ...
  const mockData = {
    ...
    moderatorEfficiency: {
      ...
      workloadDistribution: [
        { moderator: "Sarah_Admin", reviews: 1247, accuracy: 98.2, avgTime: 1.8 },
      ...
      burnoutRisk: [
        { moderator: "Alex_Mod", riskLevel: 78, reason: "High volume, long hours" },
        { moderator: "Casey_Mod", riskLevel: 65, reason: "Difficult content exposure" }
      ]
    },
    platformComparison: [
      {
    ...
    predictiveAnalytics: {
      ...
      trendsDetected: [
        { trend: "Increased deepfake content", severity: "high", confidence: 92 },
        { trend: "Coordinated spam campaigns", severity: "medium", confidence: 84 },
    ...
    <div className="min-h-screen cyber-bg">
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold cyber-text-glow">Advanced Analytics Center</h1>
            <p className="text-muted-foreground">Deep Insights & Predictive Intelligence</p>
          </div>
          ...
          <Card className="cyber-card">
            <CardContent className="p-4 text-center">
              ...
              <div className="flex items-center justify-center mt-1">
                ...
                <span className="text-xs text-green-400">+{mockData.contentAnalysis.growthRate}%</span>
              </div>
            </CardContent>
          </Card>
          <Card className="cyber-card">
        ...
        <Tabs defaultValue="content" className="space-y-6">
          ...
          <TabsContent value="content" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="cyber-card neural-network">
                <CardHeader>
                  <CardTitle className="cyber-text-glow">CONTENT TYPE ANALYSIS</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {Object.entries(mockData.contentAnalysis.contentTypes).map(([type, data]) => (
                      <div key={type} className="flex items-center justify-between p-3 cyber-card border border-primary/20">
                        ...
                        <div className="text-right">
                          <div className="text-sm font-bold text-red-400">{data.risk}% risk</div>
                          <div className="text-xs text-muted-foreground">{data.blocked} blocked</div>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <Card className="cyber-card">
                <CardHeader>
                  <CardTitle className="cyber-text-glow">AI PERFORMANCE METRICS</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-blue-400">
                        {mockData.contentAnalysis.aiPerformance.averageProcessingTime}s
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
            ...
            <Card className="cyber-card">
              <CardHeader>
                <CardTitle className="cyber-text-glow">RISK DISTRIBUTION ANALYSIS</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-4 gap-6">
                  {Object.entries(mockData.contentAnalysis.riskDistribution).map(([level, percentage]) => (
                    <div key={level} className="text-center">
                      <div className={`text-3xl font-bold mb-2 ${
                        level === 'safe' ? 'text-green-400' :
                        level === 'suspicious' ? 'text-yellow-400' :
                        level === 'flagged' ? 'text-orange-400' : 'text-red-400'
                      } cyber-text-glow`}>
                        {percentage}%
                      </div>
                      ...
                      <div className="w-full bg-muted rounded-full h-2 mt-2">
                        <div 
                          className={`h-2 rounded-full ${
                            ...
                            level === 'flagged' ? 'bg-orange-400' : 'bg-red-400'
                          }`}
          ...
          <TabsContent value="behavior" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="cyber-card">
                <CardHeader>
                  <CardTitle className="cyber-text-glow">USER ACTIVITY PATTERNS</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
              ...
              <Card className="cyber-card">
                <CardHeader>
                  <CardTitle className="cyber-text-glow">GEOGRAPHIC RISK DISTRIBUTION</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {mockData.userBehavior.geographicDistribution.map((region, index) => (
                      <div key={region.region} className="flex items-center justify-between p-3 cyber-card border border-primary/20">
                        <div className="flex items-center space-x-3">
                        ...
                        <div className="text-right">
                          <div className="text-sm font-bold">{region.users}% users</div>
                          <div className={`text-xs ${
                            region.risk < 3 ? 'text-green-400' :
                            region.risk < 5 ? 'text-yellow-400' : 'text-red-400'
                          }`}>
                            {region.risk}% risk
                          </div>
                        </div>
          ...
          <TabsContent value="moderators" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="cyber-card">
                <CardHeader>
                  <CardTitle className="cyber-text-glow">MODERATOR PERFORMANCE</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {mockData.moderatorEfficiency.workloadDistribution.map((mod, index) => (
                      <div key={mod.moderator} className="flex items-center justify-between p-3 cyber-card border border-primary/20">
                        <div className="flex items-center space-x-3">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${
                            index === 0 ? 'bg-primary text-white' :
                            index === 1 ? 'bg-secondary text-white' :
                            index === 2 ? 'bg-accent text-white' : 'bg-muted text-foreground'
                          }`}>
                            {mod.moderator.split('_')[0][0]}
                          </div>
                          <div>
                            <div className="font-medium">{mod.moderator.replace('_', ' ')}</div>
                            <div className="text-sm text-muted-foreground">
                              {mod.reviews} reviews
                            </div>
                          </div>
                        ...
                        <div className="text-right">
                          <div className="text-sm font-bold text-green-400">{mod.accuracy}%</div>
                          <div className="text-xs text-muted-foreground">{mod.avgTime}min avg</div>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <Card className="cyber-card">
                <CardHeader>
                  <CardTitle className="cyber-text-glow">BURNOUT RISK ASSESSMENT</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="p-4 border border-yellow-500/20 rounded-lg">
                      <h4 className="font-medium text-yellow-400 mb-2">Moderate Risk Detected</h4>
                      <p className="text-sm text-muted-foreground mb-3">
                        2 moderators showing signs of potential burnout
                      </p>
                      <div className="space-y-2">
                        {mockData.moderatorEfficiency.burnoutRisk.map((risk, index) => (
                          <div key={risk.moderator} className="flex items-center justify-between">
                            <span className="text-sm">{risk.moderator.replace('_', ' ')}</span>
                            <div className="text-right">
                              <div className="text-sm font-bold text-yellow-400">{risk.riskLevel}%</div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-3 cyber-card">
                        <div className="text-xl font-bold text-primary">{mockData.moderatorEfficiency.totalModerators}</div>
                        <div className="text-xs text-muted-foreground">Total Staff</div>
                      </div>
                      <div className="text-center p-3 cyber-card">
                        <div className="text-xl font-bold text-green-400">{mockData.moderatorEfficiency.activeModerators}</div>
          ...
          <TabsContent value="platforms" className="space-y-6">
            <Card className="cyber-card neural-network">
              <CardHeader>
                <CardTitle className="cyber-text-glow">CROSS-PLATFORM PERFORMANCE COMPARISON</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  {mockData.platformComparison.map((platform, index) => (
                    <div key={platform.platform} className="p-4 cyber-card border border-primary/20">
                      <h3 className="font-medium mb-4">{platform.platform}</h3>
                      <div className="grid grid-cols-5 gap-4">
                        <div className="text-center">
                          <div className="text-lg font-bold text-primary">
                            {(platform.metrics.contentVolume / 1000).toFixed(0)}K
                          </div>
                          <div className="text-xs text-muted-foreground">Content Volume</div>
                        </div>
                        <div className="text-center">
                          <div className={`text-lg font-bold ${
                            platform.metrics.riskScore > 5 ? 'text-red-400' :
                            platform.metrics.riskScore > 3 ? 'text-yellow-400' : 'text-green-400'
                          }`}>
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-xs text-muted-foreground">Moderation Speed</div>
                        </div>
                        <div className="text-center">
                        ...
                        <div className="text-center">
                          <div className={`text-lg font-bold ${
                            platform.metrics.revenueImpact < 1 ? 'text-green-400' :
                            platform.metrics.revenueImpact < 2 ? 'text-yellow-400' : 'text-red-400'
                          }`}>
          ...
          <TabsContent value="predictions" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        Confidence: {mockData.predictiveAnalytics.riskForecast.nextWeek.confidence}%
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="text-xs text-muted-foreground">
                        Confidence: {mockData.predictiveAnalytics.riskForecast.nextMonth.confidence}%
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="text-xs text-muted-foreground">
                        Confidence: {mockData.predictiveAnalytics.riskForecast.seasonal.confidence}%
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-primary">+{mockData.predictiveAnalytics.resourceNeeds.moderatorsNeeded}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm">Server Capacity Increase</span>
                      <span className="font-bold text-blue-400">+{mockData.predictiveAnalytics.resourceNeeds.serverCapacity}%</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm">Budget Impact</span>
                      <span className="font-bold text-yellow-400">+${mockData.predictiveAnalytics.resourceNeeds.budgetImpact}K</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="cyber-card">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {mockData.predictiveAnalytics.trendsDetected.map((trend, index) => (
                      <div key={index} className="p-3 cyber-card border border-primary/20">
                        <div className="flex items-start justify-between mb-2">
                          <div className="font-medium text-sm">{trend.trend}</div>
                          <Badge className={trend.severity === 'high' ? 'bg-red-600' : 'bg-yellow-600'}>
                            {trend.severity}
                          </Badge>
                        </div>
                        <div className="text-xs text-muted-foreground">

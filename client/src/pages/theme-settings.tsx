...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const colorPresets = [
    { name: "Cyberpunk Purple", primary: "#8B5CF6", navbar: "#1F2937", footer: "#111827" },
    { name: "Electric Blue", primary: "#3B82F6", navbar: "#1E40AF", footer: "#1E3A8A" },
    { name: "Neon Green", primary: "#10B981", navbar: "#065F46", footer: "#064E3B" },
    { name: "Hot Pink", primary: "#EC4899", navbar: "#9D174D", footer: "#831843" },
    { name: "Sunset Orange", primary: "#F59E0B", navbar: "#92400E", footer: "#78350F" },
    { name: "Blood Red", primary: "#EF4444", navbar: "#991B1B", footer: "#7F1D1D" }
  ];
  ...
  return (
    <div className="container mx-auto p-6 space-y-6" data-testid="theme-settings">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold cyber-text-glow">Theme Customization</h1>
          <p className="text-muted-foreground">
            Customize platform branding, colors, layouts, and styling
          </p>
        </div>
        <div className="flex items-center space-x-2">
          <Button variant="outline" onClick={exportTheme} data-testid="button-export-theme">
        ...
        <Card className="cyber-border border-blue-200 bg-blue-50">
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-medium text-blue-800">Preview Mode Active</h3>
                <p className="text-sm text-blue-700">
                  You're viewing how the theme changes will appear on the platform
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <CardContent className="space-y-6">
                    ...
                    <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center">
                      {themeSettings.logoUrl ? (
                        <div className="space-y-2">
                          ...
                          />
                          <p className="text-sm text-muted-foreground">Current main logo</p>
                        </div>
                      ) : (
                        <div className="space-y-2">
                      ...
                      <Label htmlFor="main-logo" className="cursor-pointer">
                        <Button variant="outline" className="mt-2" data-testid="button-upload-main-logo">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center">
                      {themeSettings.logoBlueUrl ? (
                        <div className="space-y-2">
                          <img 
                            ...
                            className="max-h-16 mx-auto"
                          />
                          <p className="text-sm text-muted-foreground">Alternative logo variant</p>
                        </div>
                      ) : (
                        <div className="space-y-2">
                          <ImageIcon className="h-12 w-12 mx-auto text-muted-foreground" />
                          <p className="text-sm text-muted-foreground">No alt logo uploaded</p>
                        </div>
                      )}
                      <input
                        type="file"
                      ...
                      <Label htmlFor="blue-logo" className="cursor-pointer">
                        <Button variant="outline" className="mt-2" data-testid="button-upload-blue-logo">
                          <Upload className="h-4 w-4 mr-2" />
                          Upload Alt Logo
                        </Button>
                      </Label>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center">
                      ...
                      <Label htmlFor="favicon" className="cursor-pointer">
                        <Button variant="outline" className="mt-2" data-testid="button-upload-favicon">
                          <Upload className="h-4 w-4 mr-2" />
                          Upload Favicon
                        </Button>
                      </Label>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center">
                      {themeSettings.watermarkVideoUrl ? (
                        <div className="space-y-2">
                          <img 
                            ...
                            className="max-h-16 mx-auto"
                          />
                          <p className="text-sm text-muted-foreground">Video watermark</p>
                        </div>
                      ) : (
                        <div className="space-y-2">
                          <ImageIcon className="h-12 w-12 mx-auto text-muted-foreground" />
                          <p className="text-sm text-muted-foreground">No watermark uploaded</p>
                        </div>
                      )}
                      <input
                        type="file"
                      ...
                      <Label htmlFor="watermark" className="cursor-pointer">
                        <Button variant="outline" className="mt-2" data-testid="button-upload-watermark">
                          <Upload className="h-4 w-4 mr-2" />
                          Upload Watermark
                        </Button>
                      </Label>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    { key: 'indexImageTop', label: 'Hero Background', testId: 'hero-bg' },
                    { key: 'background', label: 'Page Background', testId: 'page-bg' },
                    { key: 'avatarDefault', label: 'Default Avatar', testId: 'default-avatar' }
                    ...
                    <div key={key} className="space-y-2">
                      ...
                      <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center">
                        {themeSettings[`${key}Url` as keyof ThemeSettings] ? (
                          <img 
                            src={themeSettings[`${key}Url` as keyof ThemeSettings] as string} 
                            alt={label}
                        ...
                        <Label htmlFor={key} className="cursor-pointer">
                          <Button variant="outline" size="sm" className="mt-2" data-testid={`button-upload-${testId}`}>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Input
                        ...
                        onChange={(e) => handleThemeChange('themePwaColor', e.target.value)}
                        className="w-16 h-10 p-1 border rounded"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Input
                        ...
                        onChange={(e) => handleThemeChange('navbarBackgroundColor', e.target.value)}
                        className="w-16 h-10 p-1 border rounded"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Input
                        ...
                        onChange={(e) => handleThemeChange('navbarTextColor', e.target.value)}
                        className="w-16 h-10 p-1 border rounded"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      onChange={(e) => handleThemeChange('footerBackgroundColor', e.target.value)}
                      className="w-16 h-10 p-1 border rounded"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      onChange={(e) => handleThemeChange('footerTextColor', e.target.value)}
                      className="w-16 h-10 p-1 border rounded"
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleThemeChange('homeStyle', parseInt(value))}
                  >
                ...
                <div className="border rounded-lg p-4 bg-muted/30">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Button 
                        size="sm"
                        className={`${themeSettings.buttonStyle === 'square' ? 'rounded-none' : 
                          themeSettings.buttonStyle === 'pill' ? 'rounded-full' : 'rounded'}`}
  ...
  border: 1px solid rgba(139, 92, 246, 0.3);
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => handleThemeChange('customJs', e.target.value)}
                    className="font-mono text-sm min-h-[300px]"
              ...
              <Card className="border-yellow-200 bg-yellow-50">
                <CardContent className="p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-yellow-800">Custom Code Safety</h3>
                      <ul className="text-sm text-yellow-700 mt-2 space-y-1">
                        <li>• Test custom code thoroughly before applying to production</li>
                        <li>• Avoid inline styles that might conflict with existing CSS</li>
                        <li>• Use proper CSS selectors to avoid affecting unintended elements</li>
                        <li>• Backup your theme before making major changes</li>
                        <li>• Custom JavaScript can affect site performance and security</li>
                      </ul>
                    </div>
                  </div>
                </CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <Badge variant="outline">{getHomeStyleName(themeSettings.homeStyle)}</Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Button Style:</span>
                      <Badge variant="outline">{themeSettings.buttonStyle}</Badge>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <Badge variant={themeSettings.customCss ? "default" : "secondary"}>
                        {themeSettings.customCss ? "Active" : "None"}
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Custom JS:</span>
                      <Badge variant={themeSettings.customJs ? "default" : "secondary"}>
                        {themeSettings.customJs ? "Active" : "None"}
                      </Badge>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Logo:</span>
                      <Badge variant={themeSettings.logoUrl ? "default" : "secondary"}>

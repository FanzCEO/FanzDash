...
export default function LogoFaviconManagement() {
  ...
  const [currentUploadType, setCurrentUploadType] = useState<keyof LogoConfig>('mainLogo');
  ...
  const handleFileUpload = async (file: File, type: keyof LogoConfig) => {
    ...
    if (!validTypes.includes(file.type)) {
      toast({
        ...
        description: "Please upload a valid image file (JPG, PNG, GIF, SVG, ICO)",
        variant: "destructive"
      });
      return;
    }
  ...
  const generateFavicons = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "All favicon sizes have been automatically generated from your main logo",
      });
    } catch (error) {
      toast({
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your brand logos and website favicons across all devices and platforms
          </p>
        </div>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex space-x-2">
                <Input
                  ...
                  onChange={(e) => setConfig(prev => ({ ...prev, msTileColor: e.target.value }))}
                  placeholder="#603cba"
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              • Main Logo: SVG format, transparent background, minimum 200px height<br />
              • Favicons: PNG format, square aspect ratio (16x16, 32x32, 192x192)<br />
              • Apple Touch Icon: PNG format, 180x180 pixels<br />
              • Dark logos should have light-colored elements for visibility
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>

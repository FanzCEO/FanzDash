...
export default function SystemConfiguration() {
  ...
  const [config, setConfig] = useState<SystemConfig>({
    ...
    verificationRequirements: "Government ID, Social Media Verification, Phone Number"
  });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateConfig('forceHttps', checked)}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Show CAPTCHA on login/registration</p>
                  </div>
                  <Switch
                    id="enable-captcha"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="strong-password">Strong Password Policy</Label>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="enable-compression">Image Compression</Label>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateConfig('enableImageCompression', checked)}
              ...
              <Alert>
                ...
                <AlertDescription>
                  ...
                  Images: {config.allowedImageTypes.join(', ')}<br />
                  Videos: {config.allowedVideoTypes.join(', ')}<br />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Cache static content for faster loading</p>
                  </div>
                  <Switch
                    id="enable-caching"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateConfig('enableCdn', checked)}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateConfig('minifyAssets', checked)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateConfig('enableComments', checked)}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Require approval before comments appear</p>
                  </div>
                  <Switch
                    id="moderate-comments"
                    checked={config.moderateComments}
                    onCheckedChange={(checked) => updateConfig('moderateComments', checked)}
                ...
                <div className="space-y-2">
                  <Label htmlFor="default-privacy">Default Post Privacy</Label>
                  <Select value={config.defaultPostPrivacy} onValueChange={(value: any) => updateConfig('defaultPostPrivacy', value)}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateConfig('enableRatings', checked)}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Allow content sharing to social media</p>
                  </div>
                  <Switch
                    id="enable-sharing"
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="enable-subscriptions">Enable Subscriptions</Label>
                    <p className="text-sm text-muted-foreground">Allow creators to offer subscriptions</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Allow users to tip creators</p>
                  </div>
                  <Switch
                    id="enable-tips"
                    checked={config.enableTips}
                    onCheckedChange={(checked) => updateConfig('enableTips', checked)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateConfig('commissionRate', parseFloat(e.target.value))}
                    data-testid="commission-rate-input"
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="min-withdraw">Minimum Withdrawal Amount</Label>
                  <Input
                    id="min-withdraw"
                    type="number"
                    value={config.minWithdrawAmount}
                    onChange={(e) => updateConfig('minWithdrawAmount', parseFloat(e.target.value))}
                    data-testid="min-withdraw-input"
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="max-withdraw">Maximum Withdrawal Amount</Label>
                  <Input
                    id="max-withdraw"
                    type="number"
                    value={config.maxWithdrawAmount}
                    onChange={(e) => updateConfig('maxWithdrawAmount', parseFloat(e.target.value))}
                    data-testid="max-withdraw-input"
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="withdrawal-processing">Withdrawal Processing Days</Label>
                  <Input
                    id="withdrawal-processing"
                    type="number"
                    value={config.withdrawalProcessingDays}
                    onChange={(e) => updateConfig('withdrawalProcessingDays', parseInt(e.target.value))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Allow real-time messaging</p>
                  </div>
                  <Switch
                    id="enable-live-chat"
                    checked={config.enableLiveChat}
                    onCheckedChange={(checked) => updateConfig('enableLiveChat', checked)}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="enable-video-call">Enable Video Calls</Label>
                    <p className="text-sm text-muted-foreground">Allow video communication</p>
                  </div>
                  <Switch
                    id="enable-video-call"
                    checked={config.enableVideoCall}
                    onCheckedChange={(checked) => updateConfig('enableVideoCall', checked)}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="enable-audio-call">Enable Audio Calls</Label>
                    <p className="text-sm text-muted-foreground">Allow voice communication</p>
                  </div>
                  <Switch
                    id="enable-audio-call"
                    checked={config.enableAudioCall}
                    onCheckedChange={(checked) => updateConfig('enableAudioCall', checked)}
                    data-testid="enable-audio-call-toggle"
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="chat-message-limit">Daily Message Limit</Label>
                  <Input
                    id="chat-message-limit"
                    type="number"
                    value={config.chatMessageLimit}
                    onChange={(e) => updateConfig('chatMessageLimit', parseInt(e.target.value))}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="message-encryption">Message Encryption</Label>
                    <p className="text-sm text-muted-foreground">Encrypt private messages</p>
                  </div>
                  <Switch
                    id="message-encryption"
                    checked={config.enableMessageEncryption}
                    onCheckedChange={(checked) => updateConfig('enableMessageEncryption', checked)}
        ...
        <TabsContent value="system" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateConfig('enableAutoBackup', checked)}
                ...
                <div className="space-y-2">
                  ...
                  <Select value={config.backupFrequency} onValueChange={(value: any) => updateConfig('backupFrequency', value)}>
              ...
              <Alert className={config.maintenanceMode ? "border-yellow-500" : ""}>
                <AlertTriangle className="h-4 w-4" />
                <AlertDescription>
                  {config.maintenanceMode 

...
import { Shield, Lock, Eye, AlertTriangle, Zap, Terminal, Database, Key } from "lucide-react";
        ...
        <CardHeader className="relative z-10">
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground cyber-text-glow">ENCRYPTED VAULT</h2>
                <p className="text-sm text-muted-foreground">Executive Access Required</p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              <div className={`w-3 h-3 rounded-full ${isUnlocked ? 'bg-secondary' : 'bg-destructive'} cyber-pulse`}></div>
              <span className="text-sm font-mono">{isUnlocked ? 'UNLOCKED' : 'SECURED'}</span>
            </div>
          </CardTitle>
        </CardHeader>
          ...
          {!isUnlocked ? (
            <div className="space-y-6">
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold mb-2">Master Password Required</h3>
                <p className="text-muted-foreground mb-6">Access to illegal/sensitive content evidence</p>
              ...
              <div className="border-t border-border/30 pt-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Vaulted Items</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Executive Reviews</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">All access is logged and monitored</p>
        </div>
        <Button variant="outline" className="neon-button text-destructive border-destructive">
      ...
      <div className="grid gap-4">
        {vaultItems.map((item) => (
          <Card key={item.id} className="cyber-card bg-destructive/5 border-destructive/30 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                <div>
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                      <div className="font-mono text-sm font-bold">{item.id}</div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-mono text-secondary">{item.encryptionLevel}</span>
                  </div>
                  <div className="flex justify-between text-xs">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-mono text-accent">{item.accessCount}</span>
                  </div>
                  <div className="flex justify-between text-xs">
                    ...
                    <DialogContent className="max-w-4xl cyber-card">
                      ...
                      <div className="space-y-4">
                        <div className="p-4 bg-destructive/10 border border-destructive/30 rounded-lg">
                          <p className="text-sm text-destructive font-medium mb-2">⚠️ WARNING: SENSITIVE CONTENT</p>
                          <p className="text-sm text-muted-foreground">
                            This content has been encrypted and vaulted due to its illegal nature. 
                            Access is strictly monitored and logged.
                          </p>
                        </div>
                        <div className="text-center py-8">
                          <Lock className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
                          <p className="text-muted-foreground">Content preview disabled for security</p>

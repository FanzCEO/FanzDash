...
interface Notification {
  id: string;
  type: 'ticket_assigned' | 'ticket_updated' | 'message_received' | 'escalation' | 'satisfaction_low' | 'sla_breach' | 'system_alert';
  title: string;
  message: string;
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      {notification.ticketId && (
                        <DropdownMenuItem onClick={() => onNavigateToTicket(notification.ticketId!)}>
              ...
              <div className="flex items-center justify-between text-xs text-muted-foreground">
                <div className="flex items-center space-x-4">
                  {notification.ticketNumber && (
                    <span className="font-mono">#{notification.ticketNumber}</span>
                  )}
                  {notification.userName && (
                    <div className="flex items-center space-x-1">
                      <Avatar className="h-4 w-4">
                        <AvatarImage src={notification.userAvatar} />
                        <AvatarFallback className="text-xs">{notification.userName.charAt(0)}</AvatarFallback>
                      </Avatar>
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-6 py-4">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        {localSettings.desktopNotifications && Notification.permission === 'default' && (
                          <Button 
                            variant="ghost" 
                            size="sm" 
                ...
                <Card>
                  ...
                  <CardContent>
                    <Select
                      ...
                      onValueChange={(value: any) => updateSettings({ emailFrequency: value })}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {Object.entries(localSettings.channels).map(([type, enabled]) => {
                        ...
                        <div key={type} className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => updateSettings({
                              channels: { ...localSettings.channels, [type]: checked }
                            })}
                          />
                        </div>
                      );
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => updateSettings({
                          quietHours: { ...localSettings.quietHours, enabled: checked }
                        })}
                      />
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) => updateSettings({
                              quietHours: { ...localSettings.quietHours, startTime: value }
                            })}
                          >
                            <SelectTrigger>
                              <SelectValue />
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) => updateSettings({
                              quietHours: { ...localSettings.quietHours, endTime: value }
                            })}
                          >
                            <SelectTrigger>
                              <SelectValue />

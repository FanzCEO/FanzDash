...
export const supportTickets = pgTable("support_tickets", {
  ...
  assignedAgentId: uuid("assigned_agent_id").references(() => supportAgents.id),
  departmentId: uuid("department_id").references(() => supportDepartments.id),
...
// Ticket Categories
export const supportCategories: any = pgTable("support_categories", {
  id: uuid("id").primaryKey().default(sql`gen_random_uuid()`),
  name: varchar("name", { length: 100 }).notNull(),
  description: text("description"),
  ...
  isActive: boolean("is_active").default(true),
  autoAssignAgentId: uuid("auto_assign_agent_id").references(() => supportAgents.id),
...
export const knowledgeBaseCategories: any = pgTable("knowledge_base_categories", {
  id: uuid("id").primaryKey().default(sql`gen_random_uuid()`),
  name: varchar("name", { length: 100 }).notNull(),
  description: text("description"),
...
export const supportAnalytics = pgTable("support_analytics", {
  ...
  avgFirstResponseTime: decimal("avg_first_response_time", { precision: 10, scale: 2 }),
  avgResolutionTime: decimal("avg_resolution_time", { precision: 10, scale: 2 }),
